...
The following images show the general settings you should configure on the modbus adapter. You can take the same parameter values except for the IP adress. Configure the IP adress as you did in the go-eCharger adapter settings but this time for your inverter. I'm sorry for the german example pictures but I think it will be enough for you to figure out where to put which value.
